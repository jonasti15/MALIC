...
public class ModeloTablaAvistamientos extends AbstractTableModel {
    ...
    private void inicializar() {
        for(int i=0;i<10;i++){
            this.avistamientos.add(new Avistamiento((long)i,"Avistamiento numero "+i,new Date(2020,2,2),"Localizacion "+i,new User("User "+i, Permisos.getPermiso("W")), new Especie((long)i, "Especie"+ i,new Clase(i, "Clase "+i))));
        }
    }
